 ...
 *                 msg:
 *                   type: string
 *                   example: Successfully generated new AccessToken and RefreshToken
 *       400:
 ...
 *                 messages:
 *                   type: string
 *                   example: User ID is required, Refresh Token must match User ID
 *       401:
 ...
 *                 msg:
 *                   type: string
 *                   example: Failed to verify refreshToken
 *       404:
 *         description: User not found
 *         content:
 *           application/json:
